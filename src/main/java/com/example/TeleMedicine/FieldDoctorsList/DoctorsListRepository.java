...
public class DoctorsListRepository {
	...
	public List<Map<String, Object>> getDoctorsList() {
		...
		query.append(" d.gender_name gender,a.license,a.cost,b.dept_name,a.experience, c.about,a.status ");
		query.append(",e.session_time,group_concat(g.shortname) specilaization,e.from_time,e.to_time ");
		...
		query.append(
				" left join telemedicine_master.tbl_medical_specializations g on g.specialization_id=f.specialization_id ");
