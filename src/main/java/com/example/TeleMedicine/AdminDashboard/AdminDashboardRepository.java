...
public class AdminDashboardRepository {
	...
	public Map<String, Object> dashBoardData(Map<String, Object> data) {
		...
		int doctorsCount = jdbcTemplate.queryForObject("SELECT count(*) from telemedicine_doctors.tbl_doctor_registration", Integer.class);
		int patientsCount = jdbcTemplate.queryForObject("SELECT count(*) from telemedicine_patients.tbl_patient_registration", Integer.class);
		int appointmentsCount = jdbcTemplate.queryForObject("SELECT count(*) from telemedicine_master.tbl_appointments", Integer.class);
