...
public class AdminPatientsRepository {
	...
	public Map<String, Object> getPatientProfile(int patientId) {
		...
		appointmentsHistoryQuery.append(" left join telemedicine_patients.tbl_patient_registration b on a.patient_id=b.patient_id ");
		appointmentsHistoryQuery.append(" left join telemedicine_doctors.tbl_doctor_registration c on a.doctor_id=c.doctor_id ");
		...
		List<Map<String, Object>> medicalHistory = jdbcTemplate
				.queryForList("select * from telemedicine_patients.tbl_patient_medical_history where patient_id=?", new Object[] { patientId });
